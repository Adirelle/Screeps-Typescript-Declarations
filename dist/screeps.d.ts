...
interface NewFindPathOpts extends CommonFindPathOpts {
    /**
     * Ignore road structures. Enabling this option can speed up the search. The default value is false.
     */
    ignoreRoads?: boolean;
    /**
     * You can use this callback to modify a CostMatrix for any room during the search. The callback accepts two arguments, roomName and costMatrix. Use the costMatrix instance to make changes to the positions costs. If you return a new matrix from this callback, it will be used instead of the built-in cached one.
     */
    ...
    maxRooms?: number;
    /**
     * The maximum range for which the goal is considered reached. The default is 0.
     */
    range?: number;
}
interface OldFindPathOpts extends CommonFindPathOpts {
    /**
     ...
     */
    ignore?: Array<RoomPosition | RoomObject>;
    /**
     ...
     */
    avoid?: Array<RoomPosition | RoomObject>;
}
declare type FindPathOpts = NewFindPathOpts | OldFindPathOpts;
declare type MoveToOpts = FindPathOpts & {
    /**
